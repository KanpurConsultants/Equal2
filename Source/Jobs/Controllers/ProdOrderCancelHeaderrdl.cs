...
{
    public class ProdOrderCancelHeaderRDL
    {

        public string Create_Std_ProdOrderCancel_Print()
        {
            string StringCode = "";
  ...
  <DataSets>
    <DataSet Name=""DsMain"">
      <Query>
        ...
        <CommandText>Web.ProcProdOrderCancelPrint</CommandText>
      </Query>
      <Fields>
        <Field Name=""ProdOrderCancelHeaderId"">
          <DataField>ProdOrderCancelHeaderId</DataField>
