...
{
    public class SaleOrderHeaderRDL
    {

        public string Create_Std_SaleOrder_Print()
        {
            string StringCode = "";
  ...
  <DataSets>
    <DataSet Name=""DsMain"">
      <Query>
        ...
        <CommandText>Web.ProcSaleOrderPrint</CommandText>
      </Query>
      <Fields>
