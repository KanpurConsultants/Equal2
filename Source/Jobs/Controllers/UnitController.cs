...
namespace Jobs.Controllers
{
    ...
    public class UnitController : System.Web.Mvc.Controller
    {
        ...
        {
            var DocType = new DocumentTypeService(_unitOfWork).FindByName(DocumentTypeConstants.Unit.DocumentTypeName);
            int DocTypeId = 0;

            if (DocType != null)
                DocTypeId = DocType.DocumentTypeId;
            else
                return View("~/Views/Shared/InValidSettings.cshtml").Warning("Document Type named " + DocumentTypeConstants.Unit.DocumentTypeName + " is not defined in database.");
        ...
        public ActionResult Create(UnitViewModel vm)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    DocTypeId = new DocumentTypeService(_unitOfWork).FindByName(DocumentTypeConstants.Unit.DocumentTypeName).DocumentTypeId,
                    DocNo = pt.UnitName,
        ...
        public ActionResult Report()
        {
            ...
            Dt = new DocumentTypeService(_unitOfWork).FindByName(DocumentTypeConstants.Unit.DocumentTypeName);
