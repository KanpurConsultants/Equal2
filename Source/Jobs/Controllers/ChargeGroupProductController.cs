...
namespace Jobs.Controllers
{
    ...
    public class ChargeGroupProductController : System.Web.Mvc.Controller
    {
        ...
        {
            var DocType = new DocumentTypeService(_unitOfWork).FindByName(DocumentTypeConstants.ChargeGroupProduct.DocumentTypeName);
            int DocTypeId = 0;

            if (DocType != null)
                DocTypeId = DocType.DocumentTypeId;
            else
                return View("~/Views/Shared/InValidSettings.cshtml").Warning("Document Type named " + DocumentTypeConstants.ChargeGroupProduct.DocumentTypeName + " is not defined in database.");
        ...
        public ActionResult Post(ChargeGroupProduct pt)
        {
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    //LogActivity.LogActivityDetail(new DocumentTypeService(_unitOfWork).Find(DocumentTypeConstants.ChargeGroupProduct.DocumentTypeName).DocumentTypeId,
                    ...
                    {
                        DocTypeId = new DocumentTypeService(_unitOfWork).FindByName(DocumentTypeConstants.ChargeGroupProduct.DocumentTypeName).DocumentTypeId,
