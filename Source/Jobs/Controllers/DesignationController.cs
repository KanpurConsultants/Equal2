...
namespace Jobs.Controllers
{
    ...
    public class DesignationController : System.Web.Mvc.Controller
    {
        ...
        {
            var DocType = new DocumentTypeService(_unitOfWork).FindByName(DocumentTypeConstants.Designation.DocumentTypeName);
            int DocTypeId = 0;

            if (DocType != null)
                DocTypeId = DocType.DocumentTypeId;
            else
                return View("~/Views/Shared/InValidSettings.cshtml").Warning("Document Type named " + DocumentTypeConstants.Designation.DocumentTypeName + " is not defined in database.");
        ...
        public ActionResult Post(Designation vm)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (vm.DesignationId <= 0)
                {
                    ...
                    {
                        DocTypeId = new DocumentTypeService(_unitOfWork).FindByName(DocumentTypeConstants.Designation.DocumentTypeName).DocumentTypeId,
