...
{
    public class PackingHeaderRDL
    {

        public string Create_Std_Packing_Print()
        {
            string StringCode = "";
  ...
  <Body>
    <ReportItems>
                ...
                <TablixCell>
                  <CellContents>
                    <Textbox Name=""OrderBy"">
                      ...
                      <rd:DefaultName>OrderBy</rd:DefaultName>
                      <Style>
                        <Border>
                          <Style>None</Style>
                        </Border>
      ...
      <Subreport Name=""CompanyDetail"">
        ...
        <ZIndex>3</ZIndex>
        <Visibility>
          <Hidden>=iif(max(fields!Status.Value)&lt;&gt;""0"",False,true)</Hidden>
        </Visibility>
        <Style>
          <Border>
            <Style>None</Style>
      ...
      <Subreport Name=""ProvisionalCompanyDetail"">
        ...
        <ZIndex>4</ZIndex>
        <Visibility>
          <Hidden>=iif(max(fields!Status.Value)&lt;&gt;""0"",true,false)</Hidden>
        </Visibility>
        <Style>
          <Border>
            <Style>None</Style>
      ...
      <Tablix Name=""Tablix7"">
        <TablixBody>
          <TablixColumns>
            <TablixColumn>
              <Width>0.35296in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>2.89694in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>1.02523in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>1.13421in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.70712in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.69982in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>1.22907in</Width>
            </TablixColumn>
          </TablixColumns>
          <TablixRows>
            <TablixRow>
                    ...
                    <Textbox Name=""ProductName2"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=Code.PrintProduct(Fields!ProductName.Value,Fields!ProductGroupCaption.Value,fields!ProductGroupName.Value,Fields!SpecificationCaption.Value,fields!Specification.Value,fields!Dimension1Caption.Value,fields!Dimension1Name.Value,fields!Dimension2Caption.Value,fields!Dimension2Name.Value,fields!Dimension3Caption.Value,fields!Dimension3Name.Value,fields!Dimension4Caption.Value,fields!Dimension4Name.Value)</Value>
    ...
    <Height>4.43277in</Height>
    <Style />
  </Body>
  <Width>8.10275in</Width>
  <Page>
    <PageHeader>
  ...
  <DataSets>
    <DataSet Name=""DsMain"">
      <Query>
        ...
        <CommandText>Web.StdDocPrint_JobOrderCancel</CommandText>
      </Query>
      <Fields>
        <Field Name=""JobOrderCancelHeaderId"">
          <DataField>JobOrderCancelHeaderId</DataField>
        ...
        <Field Name=""ReasonName"">
          <DataField>ReasonName</DataField>
          <rd:TypeName>System.String</rd:TypeName>
        </Field>
...
str =str +"" ""+iif(C mod 2=1,"" , "","""")    
  C=C+1
     str =str +""&lt;b&gt;""+SpecificationCaption+""&lt;/b&gt;"" +""  : ""+ Specification+iif(C mod 2=0,""&lt;BR&gt;"","""")  
 End If
