...
{
    public class SaleOrderCancelHeaderRDL
    {

        public string Create_Std_SaleOrderCancel_Print()
        {
            string StringCode = "";
                    ...
                    <Textbox Name=""DocNo2"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=Fields!ReasonName.Value</Value>
                              <Style>
                                <FontFamily>tahoma</FontFamily>
                                <FontSize>9pt</FontSize>
                              </Style>
      ...
      <Tablix Name=""Tablix6"">
        <TablixBody>
          <TablixColumns>
            ...
            <TablixColumn>
              <Width>3.71654in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>1.21104in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.92306in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.41571in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>1.43455in</Width>
            </TablixColumn>
          </TablixColumns>
          <TablixRows>
            <TablixRow>
  ...
  <DataSets>
    <DataSet Name=""DsMain"">
      <Query>
        ...
        <CommandText>Web.ProcSaleOrderCancelPrint</CommandText>
      </Query>
      <Fields>
        <Field Name=""SaleOrderCancelHeaderId"">
          <DataField>SaleOrderCancelHeaderId</DataField>
