...
namespace Jobs.Controllers
{
    ...
    public class GodownController : System.Web.Mvc.Controller
    {
        ...
        {
            var DocType = new DocumentTypeService(_unitOfWork).FindByName(DocumentTypeConstants.Godown.DocumentTypeName);
            int DocTypeId = 0;

            if (DocType != null)
                DocTypeId = DocType.DocumentTypeId;
            else
                return View("~/Views/Shared/InValidSettings.cshtml").Warning("Document Type named " + DocumentTypeConstants.Godown.DocumentTypeName + " is not defined in database.");
        ...
        public ActionResult Post(Godown vm)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (vm.GodownId <= 0)
                {
                    ...
                    {
                        DocTypeId = new DocumentTypeService(_unitOfWork).FindByName(DocumentTypeConstants.Godown.DocumentTypeName).DocumentTypeId,
                        DocId = pt.GodownId,
        ...
        public ActionResult Report()
        {
            ...
            Dt = new DocumentTypeService(_unitOfWork).FindByName(DocumentTypeConstants.Godown.DocumentTypeName);
