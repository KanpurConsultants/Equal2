...
{
    public class MaterialPlanHeaderRDL
    {

        public string Create_Std_MaterialPlan_Print()
        {
            string StringCode = "";
      ...
      <Tablix Name=""Tablix6"">
        <TablixBody>
          <TablixColumns>
            ...
            <TablixColumn>
              <Width>2.18575in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.96409in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.73846in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.86456in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.84542in</Width>
            </TablixColumn>
            <TablixColumn>
                    ...
                    <Textbox Name=""Qty"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=iif(Fields!RequiredQty.Value &lt;&gt; 0, formatnumber(Fields!RequiredQty.Value,Fields!DecimalPlaces.Value),""-"")</Value>
                              <Style>
                                <FontFamily>Tahoma</FontFamily>
                                <FontSize>8.5pt</FontSize>
                              </Style>
                    ...
                    <Textbox Name=""Qty2"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=Microsoft.VisualBasic.Interaction.iif(Fields!StockPlanQty.Value &lt;&gt; 0, Microsoft.VisualBasic.Strings.formatnumber(Fields!StockPlanQty.Value, Fields!DecimalPlaces.Value), ""-"")</Value>
                              <Style>
                                <FontFamily>Tahoma</FontFamily>
                                <FontSize>8.5pt</FontSize>
                              </Style>
                    ...
                    <Textbox Name=""Qty3"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=Microsoft.VisualBasic.Interaction.iif(Fields!PurchPlanQty.Value &lt;&gt; 0, Microsoft.VisualBasic.Strings.formatnumber(Fields!PurchPlanQty.Value, Fields!DecimalPlaces.Value), ""-"")</Value>
                              <Style>
                                <FontFamily>Tahoma</FontFamily>
                                <FontSize>8.5pt</FontSize>
                              </Style>
                    ...
                    <Textbox Name=""Qty4"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=Microsoft.VisualBasic.Interaction.iif(Fields!ProdPlanQty.Value &lt;&gt; 0, Microsoft.VisualBasic.Strings.formatnumber(Fields!ProdPlanQty.Value, Fields!DecimalPlaces.Value), ""-"")</Value>
                              <Style>
                                <FontFamily>Tahoma</FontFamily>
                                <FontSize>8.5pt</FontSize>
                              </Style>
                    ...
                    <Textbox Name=""Textbox86"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=iif(sum(Fields!RequiredQty.Value) &lt;&gt; 0, formatnumber(sum(Fields!RequiredQty.Value),max(Fields!DecimalPlaces.Value)),""-"")</Value>
                              <Style>
                                <FontFamily>Tahoma</FontFamily>
                                <FontSize>8.5pt</FontSize>
                                <FontWeight>Bold</FontWeight>
                    ...
                    <Textbox Name=""Textbox87"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=Microsoft.VisualBasic.Interaction.iif(Sum(Fields!StockPlanQty.Value) &lt;&gt; 0, Microsoft.VisualBasic.Strings.formatnumber(Sum(Fields!StockPlanQty.Value), Max(Fields!DecimalPlaces.Value)), ""-"")</Value>
                              <Style>
                                <FontFamily>Tahoma</FontFamily>
                                <FontSize>8.5pt</FontSize>
                                <FontWeight>Bold</FontWeight>
                    ...
                    <Textbox Name=""Textbox88"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=Microsoft.VisualBasic.Interaction.iif(Sum(Fields!PurchPlanQty.Value) &lt;&gt; 0, Microsoft.VisualBasic.Strings.formatnumber(Sum(Fields!PurchPlanQty.Value), Max(Fields!DecimalPlaces.Value)), ""-"")</Value>
                              <Style>
                                <FontFamily>Tahoma</FontFamily>
                                <FontSize>8.5pt</FontSize>
                                <FontWeight>Bold</FontWeight>
                    ...
                    <Textbox Name=""Textbox89"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=Microsoft.VisualBasic.Interaction.iif(Sum(Fields!ProdPlanQty.Value) &lt;&gt; 0, Microsoft.VisualBasic.Strings.formatnumber(Sum(Fields!ProdPlanQty.Value), Max(Fields!DecimalPlaces.Value)), ""-"")</Value>
                              <Style>
                                <FontFamily>Tahoma</FontFamily>
                                <FontSize>8.5pt</FontSize>
                                <FontWeight>Bold</FontWeight>
  ...
  <DataSets>
    <DataSet Name=""DsMain"">
      <Query>
        ...
        <CommandText>Web.ProcMaterialPlanPrint</CommandText>
      </Query>
      <Fields>
        <Field Name=""MaterialPlanHeaderId"">
          <DataField>MaterialPlanHeaderId</DataField>
        ...
        <Field Name=""ExcessStockQty"">
          <DataField>ExcessStockQty</DataField>
          <rd:TypeName>System.Decimal</rd:TypeName>
        </Field>
        ...
        <Field Name=""StockPlanQty"">
          <DataField>StockPlanQty</DataField>
          <rd:TypeName>System.Decimal</rd:TypeName>
        </Field>
        <Field Name=""ProdPlanQty"">
          <DataField>ProdPlanQty</DataField>
          <rd:TypeName>System.Decimal</rd:TypeName>
        </Field>
        ...
        <Field Name=""PurchPlanQty"">
          <DataField>PurchPlanQty</DataField>
          <rd:TypeName>System.Decimal</rd:TypeName>
        </Field>
        <Field Name=""UnitName"">
