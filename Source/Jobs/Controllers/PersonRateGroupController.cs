...
namespace Jobs.Controllers
{
    ...
    public class PersonRateGroupController : System.Web.Mvc.Controller
    {
        ...
        {
            var DocType = new DocumentTypeService(_unitOfWork).FindByName(DocumentTypeConstants.PersonRateGroup.DocumentTypeName);
            int DocTypeId = 0;

            if (DocType != null)
                DocTypeId = DocType.DocumentTypeId;
            else
                return View("~/Views/Shared/InValidSettings.cshtml").Warning("Document Type named " + DocumentTypeConstants.PersonRateGroup.DocumentTypeName + " is not defined in database.");
        ...
        public ActionResult Post(PersonRateGroup vm)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (vm.PersonRateGroupId <= 0)
                {
                    ...
                    {
                        DocTypeId = new DocumentTypeService(_unitOfWork).Find(DocumentTypeConstants.PersonRateGroup.DocumentTypeName).DocumentTypeId,
        ...
        public ActionResult Report()
        {
            ...
            Dt = new DocumentTypeService(_unitOfWork).FindByName(DocumentTypeConstants.PersonRateGroup.DocumentTypeName);
