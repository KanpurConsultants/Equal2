...
namespace Jobs.Areas.Rug.Controllers
{
    ...
    public class ProductInvoiceGroupController : System.Web.Mvc.Controller
    {
        ...
        {
            var DocType = new DocumentTypeService(_unitOfWork).FindByName(DocumentTypeConstants.ProductInvoiceGroup.DocumentTypeName);
            int DocTypeId = 0;

            if (DocType != null)
                DocTypeId = DocType.DocumentTypeId;
            else
                return View("~/Views/Shared/InValidSettings.cshtml").Warning("Document Type named " + DocumentTypeConstants.ProductInvoiceGroup.DocumentTypeName + " is not defined in database.");
        ...
        public ActionResult Post(ProductInvoiceGroup vm)
        {
            ...
            if (ModelState.IsValid)
            {
                if (vm.ProductInvoiceGroupId <= 0)
                {
                    ...
                    {
                        DocTypeId = new DocumentTypeService(_unitOfWork).FindByName(DocumentTypeConstants.ProductInvoiceGroup.DocumentTypeName).DocumentTypeId,
        ...
        public ActionResult Report()
        {
            ...
            Dt = new DocumentTypeService(_unitOfWork).FindByName(DocumentTypeConstants.ProductInvoiceGroup.DocumentTypeName);
