...
namespace Jobs.Areas.Rug.Controllers
{
    ...
    public class ProductSizeTypeController : System.Web.Mvc.Controller
    {
        ...
        {
            var DocType = new DocumentTypeService(_unitOfWork).FindByName(DocumentTypeConstants.ProductSizeType.DocumentTypeName);
            int DocTypeId = 0;

            if (DocType != null)
                DocTypeId = DocType.DocumentTypeId;
            else
                return View("~/Views/Shared/InValidSettings.cshtml").Warning("Document Type named " + DocumentTypeConstants.ProductSizeType.DocumentTypeName + " is not defined in database.");
        ...
        public ActionResult Post(ProductSizeType vm)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (vm.ProductSizeTypeId <= 0)
                {
                    ...
                    {
                        DocTypeId = new DocumentTypeService(_unitOfWork).FindByName(DocumentTypeConstants.ProductSizeType.DocumentTypeName).DocumentTypeId,
