IF OBJECT_ID ('Web.View_PackingLineService_FGetPendingOrderQtyForDispatch_SaleOrderBalance') IS NOT NULL
	DROP VIEW [Web].[View_PackingLineService_FGetPendingOrderQtyForDispatch_SaleOrderBalance]
GO

CREATE VIEW [Web].[View_PackingLineService_FGetPendingOrderQtyForDispatch_SaleOrderBalance] AS  
