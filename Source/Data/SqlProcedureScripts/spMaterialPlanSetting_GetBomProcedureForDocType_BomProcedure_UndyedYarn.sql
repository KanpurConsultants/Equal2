CREATE PROCEDURE [Web].[spMaterialPlanSetting_GetBomProcedureForDocType_BomProcedure_UndyedYarn]
(
...
SELECT  Max(CTBom.ProdOrderLineId) AS ProdOrderLineId, CTBom.ProductId, NULL Dimension1Id, NULL  AS Dimension2Id, 
...
GROUP BY CTBom.ProductId, CTBom.ProcessId
