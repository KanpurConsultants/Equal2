...
namespace Model.Models
{
    public class SaleOrderLine : EntityBase, IHistoryLog
    {
        ...
        [Index("IX_SaleOrderLine_LineUnique", IsUnique = true, Order = 1)]
        ...
        [Index("IX_SaleOrderLine_LineUnique", IsUnique = true, Order = 2)]
        public int ProductId { get; set; }
        public virtual Product Product { get; set; }

        [Display(Name = "Dimension1")]
        [ForeignKey("Dimension1")]
        [Index("IX_SaleOrderLine_LineUnique", IsUnique = true, Order = 3)]
        public int? Dimension1Id { get; set; }
        public virtual Dimension1 Dimension1 { get; set; }

        [Display(Name = "Dimension2")]
        [ForeignKey("Dimension2")]
        [Index("IX_SaleOrderLine_LineUnique", IsUnique = true, Order = 4)]
        ...
        [Index("IX_SaleOrderLine_LineUnique", IsUnique = true, Order = 5)]
        public int? Dimension3Id { get; set; }
        public virtual Dimension3 Dimension3 { get; set; }

        [Display(Name = "Dimension4")]
        [ForeignKey("Dimension4")]
        [Index("IX_SaleOrderLine_LineUnique", IsUnique = true, Order = 6)]
        ...
        [Index("IX_SaleOrderLine_LineUnique", IsUnique = true, Order = 7)]
